...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         * page? - When you do this, the spec below fails
         */
         ...
         */
         it('has feeds with defined URLs', function() {
           for (let feed of allFeeds) { // loop through each feed object in allFeeds
             // access URL of the feed and make sure it is defined and is not empty
         ...
         */
         it('has defined names', function() {
           for (let feed of allFeeds) { // loop through each feed object in allFeeds
             // access name of the feed and make sure it is defined and is not empty
    ...
    describe('New Feed Selection', function() {
        let oldFeedHeader, newFeedHeader;
         ...
         */
         beforeEach(function(done) {
           ...
           oldFeedHeader = $('.header-title');
           loadFeed(1); // load another feedUrl
           newFeedHeader = $('.header-title');
           done();
         });

         it('when new feed is loaded, content actually changes', function() {
           expect(oldFeedHeader).not.toBe(newFeedHeader); // see if headers changed
         });
     });
